...
- **Suggested title (≤60 chars, SERP-safe):** "PPC Analytics AI Skill — Facebook & Google Ads | Coupler.io"
- **Longer H1 variant (on-page only):** "PPC Analytics AI Skill — Facebook & Google Ads performance, ROAS and CPA analysis for marketing agencies and eCommerce"
